...
int input_int_for_task(int* task, int* arr);//input chek for task
int input_int(int* input, int* arr);//input check for array numbers
int input_int_init(int* input, int* output, int* arr);//input check for array numbers
...
int input_int_for_ind_insert(int* ind_insert, int* arr);
int input_int_for_ind_delete(int* ind_delete, int* n, int* arr);
